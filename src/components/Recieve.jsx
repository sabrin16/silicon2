    ...
    <div className="recieve-info">
        ...
        <div className="recieve-info-container">
            <div className="recieve-info-inner">
                <img width="60" height="60" src={credit} alt="Credit management icon" />
                <p>Manage your payments online. Mollis congue egestas egestas fermentum fames.</p>
            </div>
            <div className="recieve-info-inner">
                <img width="60" height="60" src={bucket} alt="Bucket icon for managing funds" />
        ...
        <button className="learn-more" onClick={handleLearnMore} >
          Learn More
          <img width="20" height="20" src={iconr} alt="Arrow icon for learn more" />
        </button>
    </div>
</section>
  );
